  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center text-dark mt-28">
      ...
      <p className="text-sm max-w-2xl text-clip text-center mt-2">
        ...
        <br />
        You only need to enter your information in the form for the first time. After that, the data
        will be saved on your device, so the further input is not needed! Please wait until alert
        message appear.
      </p>
      <GoogleForm />
    </div>
